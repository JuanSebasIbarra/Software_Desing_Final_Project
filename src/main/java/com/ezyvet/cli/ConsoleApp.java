...
public class ConsoleApp implements CommandLineRunner {
    ...
    private void registerPet() {
        ...
        req.setSpecies(com.ezyvet.domain.enums.PetSpecies.valueOf(scanner.nextLine().trim().toUpperCase()));
    ...
    private void vaccinesMenu() {
        ...
        switch (opt) {
            case "1" -> {
                ...
                var vaccine = vaccineService.create(com.ezyvet.domain.entity.Vaccine.builder()
                    .name(name)
